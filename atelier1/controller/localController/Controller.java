...
public class Controller implements Mediator, BoardGame<Integer>, EventHandler<MouseEvent>  {
	...
	public OutputModelData<Integer> moveCapturePromote(Integer toMovePieceIndex, Integer targetSquareIndex) {
		...
		OutputModelData<Coord> outputControllerDataRetour = null;
		Coord squareIndex1 = transformIndexToCoord(toMovePieceIndex);
		Coord squareIndex2 = transformIndexToCoord(targetSquareIndex);
		outputControllerDataRetour = model.moveCapturePromote(squareIndex1, squareIndex2);
